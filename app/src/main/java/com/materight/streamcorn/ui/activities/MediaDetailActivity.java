...
import com.materight.streamcorn.adapters.MediaDetailAdapter;
import com.materight.streamcorn.adapters.SpinnerSeasonAdapter;
...
import com.materight.streamcorn.scrapers.models.StreamUrl;
import com.materight.streamcorn.tmdb.TmdbClient;
import com.materight.streamcorn.tmdb.models.TmdbMovie;
import com.materight.streamcorn.tmdb.models.TmdbTvSeries;
import com.materight.streamcorn.ui.customs.dialogs.MorphDialog;
import com.materight.streamcorn.ui.customs.widgets.CustomCollapsingToolbarLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaDetailAdapter.setAddToLibraryClickListener(view -> {
            ...
            if (!isSelected) {
                ...
                com.materight.streamcorn.persistence.models.Media libraryMedia = new com.materight.streamcorn.persistence.models.Media(media.getUrl(), media.getTitle(), media.getImageUrl(), channelId, media.getType());
