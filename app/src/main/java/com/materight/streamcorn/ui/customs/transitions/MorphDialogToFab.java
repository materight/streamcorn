...
package com.materight.streamcorn.ui.customs.transitions;
...
import com.materight.streamcorn.ui.customs.drawables.MorphDrawable;
...
public class MorphDialogToFab extends ChangeBounds {
    ...
    private int dialogColorResourceId = R.color.dialogBackgroundColor;
    private int fabColorResourceId = R.color.colorAccent;

    public MorphDialogToFab() {
        super();
    }

    public MorphDialogToFab(int dialogColorResourceId, int fabColorResourceId) {
        super();
        this.dialogColorResourceId = dialogColorResourceId;
        this.fabColorResourceId = fabColorResourceId;
    }
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPERTY_COLOR, ContextCompat.getColor(view.getContext(), dialogColorResourceId));
